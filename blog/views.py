...
language_translator = LanguageTranslatorV3(
        version='2018-05-01',
        iam_apikey ='j2Cbs97PYQQVHEJidW1h9f8uv3xt4sLFI0bp1FlnqBv1')

service = ToneAnalyzerV3(
    ## url is optional, and defaults to the URL below. Use the correct URL for your region.
    # url='https://gateway.watsonplatform.net/tone-analyzer/api',
   #username='apikey',
    #password='1NehTU-J1gadH2pqlnQbGREFQmhlS19c724FOvaFsmNO',
    version='2017-09-26',
    iam_apikey='1NehTU-J1gadH2pqlnQbGREFQmhlS19c724FOvaFsmNO')
